...
class MusicKitScreen extends StatefulWidget {
  const MusicKitScreen({Key? key}) : super(key: key);

  @override
  State<MusicKitScreen> createState() => _MusicKitScreenState();
}

class _MusicKitScreenState extends State<MusicKitScreen> {
