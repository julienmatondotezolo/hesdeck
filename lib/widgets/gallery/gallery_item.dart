...
class GalleryItemWidgetState extends State<GalleryItemWidget>
  ...
  AnimationController? _popoutController;
  ...
  @override
  AnimationController? get popoutController => _popoutController;

  @override
  set animation(AnimationController? value) => _controller = value;
  @override
  set focusController(AnimationController? value) => _focusController = value;
  @override
  set popoutController(AnimationController? value) => _popoutController = value;

  bool get isTransitionCompleted =>
      _controller == null || _controller!.status == AnimationStatus.completed;

  @override
  bool get isFocused => _focusController?.value == 1.0;
  bool get isPoppedOut => _popoutController?.value == 1.0;
  ...
  void _showMenu(BuildContext context) {
    print('Show me');
    // Your menu implementation using PopupMenuButton or a custom widget
    // ...
  }
...
mixin GalleryItemDragDelegate<T extends StatefulWidget> on State<T> {
  ...
  AnimationController? get focusController;
  set focusController(AnimationController? value);

  AnimationController? get popoutController;
  set popoutController(AnimationController? value);
